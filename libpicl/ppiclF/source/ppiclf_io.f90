...
module ppiclf_io
    use mpi
    ! particle data
    use ppiclf_data, only: ppiclf_npart, ppiclf_iprop, ppiclf_y1
    use ppiclf_data, only: PPICLF_Y,PPICLF_YDOT,PPICLF_YDOTC ,PPICLF_RPROP ,PPICLF_RPROP2,PPICLF_RPROP3,PPICLF_RPROP4,PPICLF_RPROP5
    ! grid data
