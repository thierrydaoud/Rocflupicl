module ppiclf_mxm
    ...
    public :: pfgslib_userExitHandler_
    public :: pfgslib_mxm
    contains
    
    ! this is not a good way to do this, but since we were discussing ditching gslib, I didn't spend a bunch of time figuring out how to do this correctly.
    SUBROUTINE pfgslib_userExitHandler_() BIND(C)
        !
        ...
        !
        return
    END SUBROUTINE pfgslib_userExitHandler_
    ...
    SUBROUTINE ppiclf_mxf6(a,n1,b,n2,c,n3)
        ...
        do j=1,n3
            do i=1,n1
                c(i,j) = a(i,1)*b(1,j) + a(i,2)*b(2,j) + a(i,3)*b(3,j) + a(i,4)*b(4,j) + a(i,5)*b(5,j) + a(i,6)*b(6,j)
            enddo
        enddo
        return
    END SUBROUTINE ppiclf_mxf6
    ...
    SUBROUTINE ppiclf_mxf7(a,n1,b,n2,c,n3)
        ...
        do j=1,n3
            do i=1,n1
                c(i,j) = a(i,1)*b(1,j) + a(i,2)*b(2,j) + a(i,3)*b(3,j) + a(i,4)*b(4,j) + a(i,5)*b(5,j) + a(i,6)*b(6,j) + a(i,7)*b(7,j)
            enddo
        enddo
        return
    END SUBROUTINE ppiclf_mxf7
    ...
    SUBROUTINE ppiclf_mxf8(a,n1,b,n2,c,n3)
        ...
        do j=1,n3
            do i=1,n1
                c(i,j) = a(i,1)*b(1,j) + a(i,2)*b(2,j) + a(i,3)*b(3,j) + a(i,4)*b(4,j) + a(i,5)*b(5,j) + a(i,6)*b(6,j) + a(i,7)*b(7,j) + a(i,8)*b(8,j)
            enddo
        enddo
        return
    END SUBROUTINE ppiclf_mxf8
    ...
    SUBROUTINE ppiclf_mxf9(a,n1,b,n2,c,n3)
        ...
        do j=1,n3
            do i=1,n1
                c(i,j) = a(i,1)*b(1,j) + a(i,2)*b(2,j) + a(i,3)*b(3,j) + a(i,4)*b(4,j) + a(i,5)*b(5,j) + a(i,6)*b(6,j) + a(i,7)*b(7,j) + a(i,8)*b(8,j) + a(i,9)*b(9,j)
            enddo
        enddo
        return
    END SUBROUTINE ppiclf_mxf9
    ...
    SUBROUTINE ppiclf_mxf10(a,n1,b,n2,c,n3)
        ...
        do j=1,n3
            do i=1,n1
                c(i,j) = a(i,1)*b(1,j) + a(i,2)*b(2,j) + a(i,3)*b(3,j) + a(i,4)*b(4,j) + a(i,5)*b(5,j) + a(i,6)*b(6,j) + a(i,7)*b(7,j) + a(i,8)*b(8,j) + a(i,9)*b(9,j) + a(i,10)*b(10,j)
            enddo
        enddo
        return
    END SUBROUTINE ppiclf_mxf10
    ...
    SUBROUTINE ppiclf_mxf11(a,n1,b,n2,c,n3)
        ...
        do j=1,n3
            do i=1,n1
                c(i,j) = a(i,1)*b(1,j) + a(i,2)*b(2,j) + a(i,3)*b(3,j) + a(i,4)*b(4,j) + a(i,5)*b(5,j) + a(i,6)*b(6,j) + a(i,7)*b(7,j) + a(i,8)*b(8,j) + a(i,9)*b(9,j) + a(i,10)*b(10,j) + a(i,11)*b(11,j)
            enddo
        enddo
        return
    END SUBROUTINE ppiclf_mxf11
    ...
    SUBROUTINE ppiclf_mxf12(a,n1,b,n2,c,n3)
        ...
        do j=1,n3
            do i=1,n1
                c(i,j) = a(i,1)*b(1,j) + a(i,2)*b(2,j) + a(i,3)*b(3,j) + a(i,4)*b(4,j) + a(i,5)*b(5,j) + a(i,6)*b(6,j) + a(i,7)*b(7,j) + a(i,8)*b(8,j) + a(i,9)*b(9,j) + a(i,10)*b(10,j) + a(i,11)*b(11,j) + a(i,12)*b(12,j)
            enddo
        enddo
        return
    END SUBROUTINE ppiclf_mxf12
    ...
    SUBROUTINE ppiclf_mxf13(a,n1,b,n2,c,n3)
        ...
        do j=1,n3
            do i=1,n1
                c(i,j) = a(i,1)*b(1,j) + a(i,2)*b(2,j) + a(i,3)*b(3,j) + a(i,4)*b(4,j) + a(i,5)*b(5,j) + a(i,6)*b(6,j) + a(i,7)*b(7,j) + a(i,8)*b(8,j) + a(i,9)*b(9,j) + a(i,10)*b(10,j) + a(i,11)*b(11,j) + a(i,12)*b(12,j) + a(i,13)*b(13,j)
            enddo
        enddo
        return
    END SUBROUTINE ppiclf_mxf13
    ...
    SUBROUTINE ppiclf_mxf14(a,n1,b,n2,c,n3)
        ...
        do j=1,n3
            do i=1,n1
                c(i,j) = a(i,1)*b(1,j) + a(i,2)*b(2,j) + a(i,3)*b(3,j) + a(i,4)*b(4,j) + a(i,5)*b(5,j) + a(i,6)*b(6,j) + a(i,7)*b(7,j) + a(i,8)*b(8,j) + a(i,9)*b(9,j) + a(i,10)*b(10,j) + a(i,11)*b(11,j) + a(i,12)*b(12,j) + a(i,13)*b(13,j) + a(i,14)*b(14,j)
            enddo
        enddo
        return
    END SUBROUTINE ppiclf_mxf14
    ...
    SUBROUTINE ppiclf_mxf15(a,n1,b,n2,c,n3)
        ...
        do j=1,n3
            do i=1,n1
                c(i,j) = a(i,1)*b(1,j) + a(i,2)*b(2,j) + a(i,3)*b(3,j) + a(i,4)*b(4,j) + a(i,5)*b(5,j) + a(i,6)*b(6,j) + a(i,7)*b(7,j) + a(i,8)*b(8,j) + a(i,9)*b(9,j) + a(i,10)*b(10,j) + a(i,11)*b(11,j) + a(i,12)*b(12,j) + a(i,13)*b(13,j) + a(i,14)*b(14,j) + a(i,15)*b(15,j)
            enddo
        enddo
        return
    END SUBROUTINE ppiclf_mxf15
    ...
    SUBROUTINE ppiclf_mxf16(a,n1,b,n2,c,n3)
        ...
        do j=1,n3
            do i=1,n1
                c(i,j) = a(i,1)*b(1,j) + a(i,2)*b(2,j) + a(i,3)*b(3,j) + a(i,4)*b(4,j) + a(i,5)*b(5,j) + a(i,6)*b(6,j) + a(i,7)*b(7,j) + a(i,8)*b(8,j) + a(i,9)*b(9,j) + a(i,10)*b(10,j) + a(i,11)*b(11,j) + a(i,12)*b(12,j) + a(i,13)*b(13,j) + a(i,14)*b(14,j) + a(i,15)*b(15,j) + a(i,16)*b(16,j)
            enddo
        enddo
        return
    END SUBROUTINE ppiclf_mxf16
    ...
    SUBROUTINE ppiclf_mxf17(a,n1,b,n2,c,n3)
        ...
        do j=1,n3
            do i=1,n1
                c(i,j) = a(i,1)*b(1,j) + a(i,2)*b(2,j) + a(i,3)*b(3,j) + a(i,4)*b(4,j) + a(i,5)*b(5,j) + a(i,6)*b(6,j) + a(i,7)*b(7,j) + a(i,8)*b(8,j) + a(i,9)*b(9,j) + a(i,10)*b(10,j) + a(i,11)*b(11,j) + a(i,12)*b(12,j) + a(i,13)*b(13,j) + a(i,14)*b(14,j) + a(i,15)*b(15,j) + a(i,16)*b(16,j) + a(i,17)*b(17,j)
            enddo
        enddo
        return
    END SUBROUTINE ppiclf_mxf17
    ...
    SUBROUTINE ppiclf_mxf18(a,n1,b,n2,c,n3)
        ...
        do j=1,n3
            do i=1,n1
                c(i,j) = a(i,1)*b(1,j) + a(i,2)*b(2,j) + a(i,3)*b(3,j) + a(i,4)*b(4,j) + a(i,5)*b(5,j) + a(i,6)*b(6,j) + a(i,7)*b(7,j) + a(i,8)*b(8,j) + a(i,9)*b(9,j) + a(i,10)*b(10,j) + a(i,11)*b(11,j) + a(i,12)*b(12,j) + a(i,13)*b(13,j) + a(i,14)*b(14,j) + a(i,15)*b(15,j) + a(i,16)*b(16,j) + a(i,17)*b(17,j) + a(i,18)*b(18,j)
            enddo
        enddo
        return
    END SUBROUTINE ppiclf_mxf18
    ...
    SUBROUTINE ppiclf_mxf19(a,n1,b,n2,c,n3)
        ...
        do j=1,n3
            do i=1,n1
                c(i,j) = a(i,1)*b(1,j) + a(i,2)*b(2,j) + a(i,3)*b(3,j) + a(i,4)*b(4,j) + a(i,5)*b(5,j) + a(i,6)*b(6,j) + a(i,7)*b(7,j) + a(i,8)*b(8,j) + a(i,9)*b(9,j) + a(i,10)*b(10,j) + a(i,11)*b(11,j) + a(i,12)*b(12,j) + a(i,13)*b(13,j) + a(i,14)*b(14,j) + a(i,15)*b(15,j) + a(i,16)*b(16,j) + a(i,17)*b(17,j) + a(i,18)*b(18,j) + a(i,19)*b(19,j)
            enddo
        enddo
        return
    END SUBROUTINE ppiclf_mxf19
    ...
    SUBROUTINE ppiclf_mxf20(a,n1,b,n2,c,n3)
        ...
        do j=1,n3
            do i=1,n1
                c(i,j) = a(i,1)*b(1,j) + a(i,2)*b(2,j) + a(i,3)*b(3,j) + a(i,4)*b(4,j) + a(i,5)*b(5,j) + a(i,6)*b(6,j) + a(i,7)*b(7,j) + a(i,8)*b(8,j) + a(i,9)*b(9,j) + a(i,10)*b(10,j) + a(i,11)*b(11,j) + a(i,12)*b(12,j) + a(i,13)*b(13,j) + a(i,14)*b(14,j) + a(i,15)*b(15,j) + a(i,16)*b(16,j) + a(i,17)*b(17,j) + a(i,18)*b(18,j) + a(i,19)*b(19,j) + a(i,20)*b(20,j)
            enddo
        enddo
        return
    END SUBROUTINE ppiclf_mxf20
    ...
    SUBROUTINE ppiclf_mxf21(a,n1,b,n2,c,n3)
        ...
        do j=1,n3
            do i=1,n1
                c(i,j) = a(i,1)*b(1,j) + a(i,2)*b(2,j) + a(i,3)*b(3,j) + a(i,4)*b(4,j) + a(i,5)*b(5,j) + a(i,6)*b(6,j) + a(i,7)*b(7,j) + a(i,8)*b(8,j) + a(i,9)*b(9,j) + a(i,10)*b(10,j) + a(i,11)*b(11,j) + a(i,12)*b(12,j) + a(i,13)*b(13,j) + a(i,14)*b(14,j) + a(i,15)*b(15,j) + a(i,16)*b(16,j) + a(i,17)*b(17,j) + a(i,18)*b(18,j) + a(i,19)*b(19,j) + a(i,20)*b(20,j) + a(i,21)*b(21,j)
            enddo
        enddo
        return
    END SUBROUTINE ppiclf_mxf21
    ...
    SUBROUTINE ppiclf_mxf22(a,n1,b,n2,c,n3)
        ...
        do j=1,n3
            do i=1,n1
                c(i,j) = a(i,1)*b(1,j) + a(i,2)*b(2,j) + a(i,3)*b(3,j) + a(i,4)*b(4,j) + a(i,5)*b(5,j) + a(i,6)*b(6,j) + a(i,7)*b(7,j) + a(i,8)*b(8,j) + a(i,9)*b(9,j) + a(i,10)*b(10,j) + a(i,11)*b(11,j) + a(i,12)*b(12,j) + a(i,13)*b(13,j) + a(i,14)*b(14,j) + a(i,15)*b(15,j) + a(i,16)*b(16,j) + a(i,17)*b(17,j) + a(i,18)*b(18,j) + a(i,19)*b(19,j) + a(i,20)*b(20,j) + a(i,21)*b(21,j) + a(i,22)*b(22,j)
            enddo
        enddo
        return
    END SUBROUTINE ppiclf_mxf22
    ...
    SUBROUTINE ppiclf_mxm44_0(a, m, b, k, c, n)
        ...
        return
    END SUBROUTINE ppiclf_mxm44_0

end module ppiclf_mxm